...
std::vector<std::string> GenomicCsvFile::extensions()
{
    return {"csv", "csvc", "csvr", "csvcr"};
}

std::string GenomicCsvFile::defaultExtension()
{
    return "csvc";
}

std::string GenomicCsvFile::displayExtension()
{
    return "csv";
}
